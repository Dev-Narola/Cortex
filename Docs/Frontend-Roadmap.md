...
**Status (2026-08-29):** F9 in progress. **Parts 1–3 shipped.** Parts 4–7 still pending.
...
**Next phase:** F9 Part 4 — Keyboard Navigation & Accessibility (focus states, modal focus, forms).

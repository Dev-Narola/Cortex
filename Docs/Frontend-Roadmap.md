...
**Status (2026-08-27):** F9 in progress. **Parts 1–2 shipped.** Parts 3–7 still pending.
...
**Next phase:** F9 Part 3 — Reduced Motion & Interaction States (the dedicated reduced-motion audit + interaction-state catalogue).
